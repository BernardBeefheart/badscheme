...
${OBJECTDIR}/src/bs-errors.o: src/bs-errors.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinclude -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bs-errors.o src/bs-errors.c

${OBJECTDIR}/src/bsfiles-utils.o: src/bsfiles-utils.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinclude -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bsfiles-utils.o src/bsfiles-utils.c

${OBJECTDIR}/src/bslist.o: src/bslist.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinclude -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bslist.o src/bslist.c

${OBJECTDIR}/src/bsprogramm.o: src/bsprogramm.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinclude -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bsprogramm.o src/bsprogramm.c

${OBJECTDIR}/src/interp.o: src/interp.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinclude -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/interp.o src/interp.c

${OBJECTDIR}/src/load_file.o: src/load_file.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinclude -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/load_file.o src/load_file.c

${OBJECTDIR}/src/main.o: src/main.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinclude -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.c

${OBJECTDIR}/src/version.o: src/version.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinclude -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/version.o src/version.c
